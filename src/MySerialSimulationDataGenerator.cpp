...
U32 MySerialSimulationDataGenerator::GenerateSimulationData( U64 largest_sample_requested, U32 sample_rate, SimulationChannelDescriptor** simulation_channel )
{
...
void MySerialSimulationDataGenerator::CreateSerialByte()
{
